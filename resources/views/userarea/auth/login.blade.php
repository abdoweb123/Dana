                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="card shadow-lg border-0">
                        <div class="card-body py-5">
                            <h3 class="mb-5 text-footer fw-semibold text-center">تسجيل الدخول</h3>
                            <x-alert></x-alert>
                            <form action="{{ route('login.post') }}" method="POST">
                                @csrf
                                <div class=" text-center row d-flex justify-content-center">
                                    <div class="form-outline mb-4 col-sm-10">
                                        <input required type="text" name="phone" class="form-control form-control-lg tel_input" id="phone">
                                        <input hidden type="text" name="country_code" value="973"
                                            class="country_code">
                                    </div>
                                    <div class="form-outline mb-4 col-sm-10">
                                        <input type="password" id="password-field" class="form-control form-control-lg"
                                    ...
                                    <div class="row d-flex flex-column justify-content-center align-items-center g-3">
                                        <div class="col-sm-10">
                                            <button class="btn text-white btn-primary rounded-2 " type="submit"
                                                style="width: -webkit-fill-available!important;"> تسجيل الدخول</button>
                                        </div>
                                        <div class="col-sm-10">
                                            <a href="{{ route('register.index') }}" class="btn btn-outline-primary rounded-2"
                                                style="width: -webkit-fill-available!important;"> إنشاء حساب
                                            </a>
                                        </div>
                                    </div>
                                </div>
